/**
 * List Item used by List Controls
 * Can be used directly as a generic list item or as a base class for customized list items
 *
 * @class o5.gui.controls.FlexGridCell
 * @extends o5.gui.controls.Control
 *
 * @author lmayle
 */

o5.gui.controls.FlexGridCell = function FlexGridCell () {};
o5.gui.controls.Control.registerO5Control(o5.gui.controls.FlexGridCell);

//o5.gui.controls.FlexGridCell = class ListItem extends HTMLElement {
//	
//	constructor ()
//	{
//		debugger;
...
//o5.gui.controls.FlexGridCell.prototype.createdCallback = function createdCallback()
//{
//	this.superCall();
//};

//o5.gui.controls.FlexGridCell.prototype.onselect = null;

//o5.gui.controls.FlexGridCell.prototype.ondeselect = null;

//o5.gui.controls.FlexGridCell.prototype.onactivate = null;

//o5.gui.controls.FlexGridCell.prototype.ondeactivate = null;
 ...
 * @type {Number}
 */
Object.defineProperty(o5.gui.controls.FlexGridCell.prototype, 'itemIndex', {
	get: function get ()
	{
 ...
 * Private properties
 */
Object.defineProperty(o5.gui.controls.FlexGridCell.prototype, '_mainStart', {
	get: function get ()
	{
...
Object.defineProperty(o5.gui.controls.FlexGridCell.prototype, '_mainEnd', {
	get: function get ()
	{
		if (this.offsetParent)
		{
...
Object.defineProperty(o5.gui.controls.FlexGridCell.prototype, '_mainLength', {
	get: function get ()
	{
		if (this.offsetParent)
		{
 ...
 * Private methods
 */
o5.gui.controls.FlexGridCell.prototype._onSelect = function _onSelect () { };

o5.gui.controls.FlexGridCell.prototype._onDeselect = function _onDeselect () { };

o5.gui.controls.FlexGridCell.prototype._onActivate = function _onActivate () { };

o5.gui.controls.FlexGridCell.prototype._onDeactivate = function _onDeactivate () { };
