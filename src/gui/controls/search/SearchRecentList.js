...
app.gui.controls.SearchRecentList.prototype.createdCallback = function createdCallback() {
	...
	$util.ControlEvents.on("app-search-query:searchRecentList", "add", function (term) {
		$service.DISCO.Search.add(term);
	}, this);
	$util.ControlEvents.on("app-search-query:searchRecentList", "clear", function () {
...
app.gui.controls.SearchRecentList.prototype._fetch = function _fetch() {
	this.logEntry();
	var me = this;
	$service.DISCO.Search.recent().then(function(data) {
