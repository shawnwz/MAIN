...
app.gui.controls.GuideReverseGrid.prototype._fetch = function _fetch(channels) {
	this.logEntry();
...
app.gui.controls.GuideReverseGrid.prototype._populate = function _populate(ctrl) {
	this.logEntry();
	this._fetchCount = this._fetchCount - 1;
