...
/*
		return $util.fetch("./service/MDS/Dummy/Event.json", $service.MDS.config.timeout)
							.then(function(data) {
											var programmes = [];
											if (data && data.programmes && data.programmes.length > 0) {
...
*/
	 ...
	 * @method _fetchData
	 */
	function _fetchData(service, startTime, endTime) {
	 ...
	 */
	function _fetchProgrammes(service, startTime, endTime) {
		var fetch = ($service.MDS.useFakeProgrammes) ? _fetchDummy : _fetchData;

		return fetch(service, startTime, endTime).then(_cacheData,
			function (data) {
	 ...
	 */
	function fetchProgrammes(service, startTime, endTime) {

		return _fetchProgrammes(service, startTime, endTime).then(function(data) {
