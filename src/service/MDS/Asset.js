...
$service.MDS.Asset = (function Asset() {
   ...
   * @method _fetchDummy
   */
  function _fetchDummy(node, token) {

    console.warn("Use dummy node assets [" + node.id + "] from MDS");
    return $util.fetchToken("./service/MDS/Dummy/Assets.json", $service.MDS.config.timeout, token)
   ...
   * @method _fetchData
   */
  function _fetchData(node, token) {
   ...
   * @method _fetchNode
   */
  function _fetchNode(node, token) {
